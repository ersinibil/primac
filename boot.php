...
$__csrf_enforced_pages = ['users.php', 'sil.php', 'notifications.php', 'accounting.php', 'finance.php', 'finance_accounts.php', 'checks_notes.php', 'kasa.php', 'finance_new.php', 'finance_transfer.php', 'finance_account_view.php', 'payment.php', 'collection.php', 'transfer.php', 'account_view.php', 'movement_view.php', 'personnel_new.php', 'personnel_edit.php', 'personnel_view.php', 'sifre_sifirla.php', 'temizle_veri.php', 'trade_document_new.php', 'teklif.php', 'quote_approve.php', 'public_file.php', 'wa_send_now.php', 'job_view.php', 'task_view.php', 'work_view.php', 'contact_new.php', 'contact_view.php', 'product_new.php', 'product_view.php', 'product_categories.php', 'product_taxonomy.php', 'stock_movement_new.php', 'brand_settings.php', 'job_new.php', 'jobs.php', 'task_new.php', 'tasks.php', 'mytask_new.php', 'mytasks.php', 'uretim_new.php', 'group_new.php'];
