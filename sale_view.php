...
<?=ds_alert('info','Bu satış tahsilat yapmadı — cariye açık borç olarak kaydedildi (kasa/banka etkilenmedi). Ödeme <a href="finance_new.php?direction=in&contact_id='.(int)$sale['contact_id'].'">Tahsilat ekranından</a> ayrıca girilir.')?>
