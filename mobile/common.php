...
function botx(){
    ...
    ?></div><div class="bottom"><div class="nav"><a href="index.php"><span>🏠</span>Ana</a><?php if($__showJobs): ?><a href="jobs.php"><span>📋</span>İş</a><?php endif; ?><?php if($__showContacts): ?><a href="contacts.php"><span>👥</span>Cari</a><?php endif; ?><a href="messages.php"><span>💬</span>Mesaj<?=$mb?></a><a href="more.php"><span>☰</span>Menü</a></div></div>
<script>
