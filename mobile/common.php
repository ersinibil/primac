...
<script>/* Ana sayfada geri butonunu gizle */(function(){var b=document.getElementById('backbtn');if(b&&(/(^|\/)index\.php$/.test(location.pathname)||/\/mobile\/?$/.test(location.pathname)))b.style.display='none';})();</script>
