...
function nav_taxonomy(){
    return [
        ...
        // SATIŞ/SATIN ALMA OPERASYON MERKEZİ (2026-07-19, Product Owner kararı, P0-2/P0-3) — nav'da
        // artık sadece "oluştur" değil, "yönet" de var. Liste kendi "+ Yeni" aksiyonu, LİSTE girişi
        // önce gelir (spec: "SATIŞLAR / + Yeni Satış").
        ['key'=>'sales_list','label'=>'Satışlar','url'=>'sales_list.php','group'=>'sat_tahsil','perm'=>'stock','primary'=>false,'actionLabel'=>'Satışları Yönet','category'=>'ticaret','categoryOrder'=>3,'isPrimaryAction'=>true,'searchKeywords'=>['satışlar','satış listesi','satış geçmişi']],
        ['key'=>'sales','label'=>'+ Yeni Satış','url'=>'sales.php','group'=>'sat_tahsil','perm'=>'stock','primary'=>false,'actionLabel'=>'Yeni Satış','category'=>'ticaret','categoryOrder'=>4,'isPrimaryAction'=>false,'searchKeywords'=>['satış','sat']],
        ['key'=>'purchase_list','label'=>'Satın Almalar','url'=>'purchase_list.php','group'=>'sat_tahsil','perm'=>'stock','primary'=>false,'actionLabel'=>'Satın Almaları Yönet','category'=>'ticaret','categoryOrder'=>5,'isPrimaryAction'=>true,'searchKeywords'=>['satın almalar','alış listesi','alış geçmişi']],
        ['key'=>'purchase','label'=>'+ Yeni Satın Alma','url'=>'purchase.php','group'=>'sat_tahsil','perm'=>'stock','primary'=>false,'actionLabel'=>'Yeni Satın Alma','category'=>'ticaret','categoryOrder'=>6,'isPrimaryAction'=>false,'searchKeywords'=>['satın alma','alış']],
        ['key'=>'teklif','label'=>'Teklifler','url'=>'teklif.php','group'=>'sat_tahsil','perm'=>'teklif','primary'=>false,'actionLabel'=>'Teklif Hazırla','category'=>'ticaret','categoryOrder'=>7,'isPrimaryAction'=>false,'searchKeywords'=>['teklif','fiyat teklifi','fiyat','proforma','quotation']],
        ['key'=>'trade_documents','label'=>'Belgeler','url'=>'trade_documents.php','mobileHide'=>true,'group'=>'sat_tahsil','perm'=>'contacts','primary'=>false,'actionLabel'=>'Alış / Satış Belgelerini Gör','category'=>'ticaret','categoryOrder'=>8,'isPrimaryAction'=>false,'searchKeywords'=>['belge','irsaliye','fatura']],
        ...
        ['key'=>'contacts_report','label'=>'Cari Ekstresi Al','url'=>'contacts_report.php','group'=>'yonet','perm'=>'contacts','primary'=>false,'category'=>'ticaret','categoryOrder'=>9,'isPrimaryAction'=>false,'searchKeywords'=>['cari ekstre','bakiye raporu']],
