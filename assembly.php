...
<?php ds_page_header('Montaj', ds_icon('briefcase',24), '', ds_button('+ Yeni Montaj İşi','job_new.php?type=montaj','primary','','',true), false, true); ?>
...
<?php
try{
$rows=db()->query("SELECT * FROM jobs WHERE job_type IN ('montaj') ORDER BY id DESC")->fetchAll();
foreach($rows as $r){
echo "<tr>
